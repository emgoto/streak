...
var getBadge = function(t) {
  ...
  if (data.habitTrackerDays) {
    ...
    const streak = getStreak(today, data.habitTrackerDays, FIRST_DAY_OF_WEEK, DAYS_IN_WEEK);
    ...
    if (streak > 6) {
      ...
      const streakUntilYesterday = getStreak(yesterday, data.habitTrackerDays, FIRST_DAY_OF_WEEK, DAYS_IN_WEEK);
