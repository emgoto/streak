...
describe('calendarDatesThisWeek', () => {
    test('There should be 5 dates from Monday to today (not including today) in a MM/DD/YYYY format', () => {
        ...
        expect(badgeUtil.calendarDatesThisWeek("MONDAY", yesterday)).toEqual(expectedValue);
    });
    ...
    test('There should be 6 dates from Sunday to today (not including today) in a MM/DD/YYYY format', () => {
        ...
        expect(badgeUtil.calendarDatesThisWeek("SUNDAY", yesterday)).toEqual(expectedValue);
    });
});
...
describe('getDatesInRange', () => {
    test('There should be 3 dates in a MM/DD/YYYY format', () => {
        ...
        expect(badgeUtil.getDatesInRange(moment('2018-12-10'), moment('2018-12-12'))).toEqual(expectedValue);
    });
});
...
describe('calendarDatesInWeek', () => {
    test('There should be 7 dates', () => {
        ...
        expect(badgeUtil.calendarDatesInWeek("MONDAY", today)).toEqual(expectedValue);
    });

    test('There should be 7 dates', () => {
        const expectedValue = ['12/09/2018', '12/10/2018', '12/11/2018', '12/12/2018', '12/13/2018', '12/14/2018', '12/15/2018'];
        expect(badgeUtil.calendarDatesInWeek("SUNDAY", today)).toEqual(expectedValue);
    });
});

describe('getStreakForWeek', () => {
    test('should return 3 if it has met daysInWeek requirement', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/10/2018', '12/12/2018', '12/14/2018'], "MONDAY", 3)).toEqual(3);
    });
    ...
    test('should start counting streak on Monday, as can still hit streak for the week (on Saturday and Sunday)', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/10/2018', '12/11/2018', '12/13/2018'], "MONDAY", 5)).toEqual(3);
    });
    ...
    test('should start counting streak on Thursday, as cannot hit streak for week if starting on Monday', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/10/2018', '12/13/2018'], "MONDAY", 5)).toEqual(1);
    });

    test('should return 0 if today is start of the week', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/09/2018', '12/08/2018'], "MONDAY", 5)).toEqual(0);
    });
    test('should return 1 if yesterday is start of the week', () => {
        yesterday = moment('2018-12-10', 'YYYY-MM-DD');
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/10/2018'], "MONDAY", 6)).toEqual(1);
    });
    test('should return 0 if yesterday is start of the week, and no dates this week', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, [], "MONDAY", 6)).toEqual(0);
    });
    test('should return 1 if many dates, but daysInWeek is only 1', () => {
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/10/2018', '12/11/2018', '12/12/2018'], "MONDAY", 1)).toEqual(1);
    });
    test('should return 2 if last 2 days in week are met', () => {
        yesterday = moment('2018-12-09', 'YYYY-MM-DD');
        expect(badgeUtil.getStreakForWeek(yesterday, ['12/08/2018', '12/09/2018'], "MONDAY", 7)).toEqual(2);
    });
    test('get streak for full week, over two different months', () => {
        const endDay = moment('12/02/2018', 'MM/DD/YYYY')
        expect(badgeUtil.getStreakForWeek(endDay, ['11/26/2018', '11/27/2018', '11/28/2018', '11/29/2018', '11/30/2018', '12/01/2018', '12/02/2018'], "MONDAY", 7)).toEqual(7);
    });
});
...
describe('getStreak', () => {
    test('if today only, should return streak of 1', () => {
        expect(badgeUtil.getStreak(today, ['12/15/2018'], "MONDAY", 7)).toEqual(1);
    });   
    test('should return full week and last day from last week', () => {
        expect(badgeUtil.getStreak(today, ['12/09/2018', '12/10/2018', '12/11/2018'], "MONDAY", 2)).toEqual(3);
    });   
    test('should return full week, last full week before that, and 1 day', () => {
        expect(badgeUtil.getStreak(today, ['12/02/2018', '12/05/2018', '12/09/2018', '12/10/2018', '12/11/2018'], "MONDAY", 2)).toEqual(5);
    });
    test('15 days straight', () => { // until 15th (today)
        expect(badgeUtil.getStreak(today, ['12/01/2018', '12/02/2018',
    ...
    test('22 days straight', () => {
        expect(badgeUtil.getStreak(today, ['11/24/2018', '11/25/2018', 
    ...
    test('random', () => {
        expect(badgeUtil.getStreak(moment('2019-03-28', 'YYYY-MM-DD'), ["12/07/2018", "12/08/2018", "12/09/2018", "12/10/2018", "12/06/2018", "12/05/2018",
